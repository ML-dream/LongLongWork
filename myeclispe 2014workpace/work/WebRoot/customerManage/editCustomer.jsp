   	...
   	<div id= "userdiv">
   		...
   		<tr>
            ...
            <td><input id="type"  name="type" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="GetCompanyTypeServlet" required="true" allowInput="false" showNullItem="true" nullItemText="请选择..." value="${customer.type}"/>  
            </td>
   		</tr>
        <tr>
            ...
            <td><input id="telephone"  name="telephone" class="mini-textbox" width="100%" required="false"  value="${customer.telephone}"/></td>

   		</tr>
   		<tr>
   		   	<td><label for="header$text">法人代表</label></td>
            <td><input id="header"  name="header" class="mini-textbox"  width="100%"  value="${customer.header}"/></td>
   			<td><label for="address$text">详细地址</label></td>
            <td><input id="address"  name="address" class="mini-textbox" style="width:100%;"  value="${customer.address}"/>  
        	</td><td><label for="postCode$text">邮编</label></td>
            <td><input id="postCode"  name="postCode" class="mini-textbox"  width="100%"  vtype="range:100000,999999" value="${customer.postCode}"/></td>
   			
        </tr>
   		<tr>
   			<td><label for="foundingTime$text">成立时间</label></td>
          	<td><input id="foundingTime" name="foundingTime" class="mini-textbox" width="100%"   emptyText="日期格式：2000-01-01"  vtype="date:yyyy-MM-dd"  value="${customer.foundingTime}" /></td>
			<td><label for="employeeNum$text">职工人数</label></td>
	        <td><input id="employeeNum"  name="employeeNum" class="mini-textbox" width="100%"  vtype="range:1,999999"  value="${customer.employeeNum}"/></td>
   			<td><label for="business$text">主营业务</label></td>
            <td><input id="business"  name="business" class="mini-textbox" width="100%"  value="${customer.business}"/></td>
   		</tr>
   		<tr>
   		...
   		<tr>
	        ...
	        <td><input id="connector3"  name="connector3" class="mini-textbox" width="100%" value="${customer.connector3}"/></td>
   			<td><label for="connector4$text">备用联系人4 </label></td>
            <td><input id="connector4"  name="connector4" class="mini-textbox" width="100%" value="${customer.connector4}"/></td>
   		</tr>
   		<tr>
            <td><label for="connector2Tel$text">联系人2电话</label></td>
	        <td><input id="connector2Tel"  name="connector2Tel" class="mini-textbox" width="100%"  required="false" emptyText="025-88888888或13612345678" value="${customer.connector2Tel}"/></td>
