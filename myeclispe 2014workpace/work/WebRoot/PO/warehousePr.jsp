...
<html>
 ...
 <a class="mini-button" plain="false" iconCls="icon-undo" onclick="javascript:window.history.back(-1);">返回</a>
  ...
  <tr bgcolor=#EBEFF5>
  <td style="width:100px;"><label for="prDate$text">开单日期</label></td>
  ...
  <td style="width:100px;"><label for="customerId$text">供应商</label></td>
  <td style="width:100px;"><input id="customerId" name="customerId" class="mini-buttonedit" width="100%" readonly value="${prsheet.customerId }"  text= "${prsheet.customerName  }" onbuttonclick="onSupplierButtonEdit" textName="customerName"  allowInput="false"/></td>
  <td style="width:100px;"><label for="sheetId$text">收货单单号</label></td>
  <td style="width:100px;"><!-- 订货单单号 <input id="purchase" name="purchase" class="mini-combobox"  value="${prsheet.purId }" readonly width="100%" textName="" textField="text" valueField="id"
  ...
  <div id="tablediv">
   	 <div id="datagrid1" class="mini-datagrid" style="width:80%;height:530px;" 
        url="SeePurchaseItem?key=${prsheet.prSheetid}&para=warehouse" idField="id" allowResize="true" pageSize="20"   multiSelect="true" allowCellSelect="true" allowCellEdit="true"
    ...
    >
 		<div property="columns">
            ...
            <div field="inNum" width="40" headerAlign="center" allowSort="false"  visible="true" >入库数量
            </div>
