...
<html>
  ...
  <td><input id="prDate" name="prDate" class="mini-datepicker" required="true" dateFormat="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd" 
  		showTodayButton="false" showClearButton="false" allowInput="false" width="100%"  value="${prsheet.prDate }" />
  ...
  <td><input id="customerId" name="customerId" class="mini-buttonedit" width="100%" value="${prsheet.customerId }"  text= "${prsheet.customerName  }" onbuttonclick="onSupplierButtonEdit" textName="customerName" required="true" allowInput="false"/></td>
  <td><label for="purchase$text">订货单单号</label></td>
  <td><input id="purchase" name="purchase" class="mini-combobox"  value="${prsheet.purId }" width="100%" textName="" textField="text" valueField="id"
  ...
  <tr bgcolor=#EBEFF5>
	  ...
	  <td><input id="salesmanId" name="salesmanId"  class="mini-buttonedit" value="${prsheet.salesmanId  }"  text= "${prsheet.salesmanName   }" width="100%" textName="salesmanName" onbuttonclick="onButtonEditEmployee" allowInput="false" required="false" readonly></td>
	  <td><label for="drawerId$text">开单人</label></td>
	  <td><input id="drawerId" name="drawerId"  class="mini-buttonedit" value="${prsheet.drawerName  }" text= "${prsheet.drawerName   }" width="100%" textName="drawerName" onbuttonclick="onButtonEditEmployee" allowInput="false" required="false" readonly></td>
  </tr>
  </table>
  
  <div id="tablediv">
   	 <div id="datagrid1" class="mini-datagrid" style="width:1300px;height:530px;" 
        url="SeeUnpassPrItem?key=${prsheet.prSheetid}" idField="id" allowResize="true" pageSize="20"   multiSelect="true" allowCellSelect="true" allowCellEdit="true"
    ...
    >
 		<div property="columns">
            ...
            <div field="warehouseId" width="80" headerAlign="center" allowSort="false" headerStyle="" renderer="onHouseRenderer" >库房
