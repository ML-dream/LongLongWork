		...
		<div id="layout1" class="mini-layout" style="width: 100%; height: 100%;">
			<div class="header" region="north"  showSplit="false" showHeader="false" style="background-color: #D9E7F8">
				...
				<div style="position:absolute;top:18px;right:10px;">   
		            ...
		            <a class="mini-button mini-button-iconTop" iconCls="icon-remove" onclick="" href="ToLogOut" plain="true" >注销</a>
<!--		            <a class="mini-button mini-button-iconTop" iconCls="icon-remove" onclick="ToStep" href="" plain="true" >跳转</a>       -->
		...
		<script type="text/javascript">
			...
			function ToStep(){
				window.location.href="http://localhost:8088/work2/qualitycheck/costConfirm.jsp";
			}
		</script>
	</body>
</html>
