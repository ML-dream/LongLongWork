  ...
  <body>
    ...
    <script type="text/javascript">
	    ...
	    function onOperatePower(e) {
	        var str = "";  
	    	str += "<span>";
	        str += "<a style='margin-right:2px;' title='审核' href=javascript:ondEdit(\'" + e.row.checksheetId+"\') ><span class='mini-button-text mini-button-icon icon-edit'>&nbsp;</span></a>";
	        str += "</span>";
	  ...
	  function ondEdit(checksheetId){
	  	...
	  	window.location="DetailExamineCheckoutServlet?checkSheetid="+checksheetId;
