    ...
    <div class="mini-fit">
        ...
        >
            <div property="columns">
                ...
                <div field="productId" width="100" headerAlign="center">物料编号</div>   
	            <div field="productName" width="100" headerAlign="center">物料名称</div>
	            ...
	            <div field="itemSpecification" width="100" headerAlign="center">物料规格</div>
            	 <div field="unitm" width="100" headerAlign="center">单位</div>          
            </div>
        </div>
...
<script type="text/javascript">
    ...
    grid.setUrl("GetItemOrderServlet?orderId="+Request['orderId']);
