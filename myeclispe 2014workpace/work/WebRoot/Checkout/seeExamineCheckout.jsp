   ...
   <div class="mini-toolbar">
  	...
  	<fieldset id="allDetail" style="width: 99%;" align="center">
		<legend>
   		...
   		<tr bgcolor=#EBEFF5>
   			<td width="8%"><label for="checkout_date$text">日期</label></td>
            ...
            <td width="8%"><label for="checksheet_id$text">单号</label></td>
            <td><input id="checksheet_id" name="checksheet_id" class="mini-textbox" width="100%" required="true" enabled="false" value="${checkout.checksheetId}" /></td>
   			<td width="8%"><label for="order_id$text">订单号</label></td>
            ...
            <td width="8%"><label for="orderStatus$text">订单状态</label></td>
   		    ...
   		    <td width="8%"><label for="companyname$text">收货单位</label></td>
       	...
       	<tr bgcolor=#EBEFF5>
        	...
        	required="true" enabled="false" value="${checkout.delivery }" text="${checkout.deliveryName }"></td>
  			...
  			allowInput="false" required="true" value="${checkout.delivery }" text="${checkout.deliveryName }"/></td>  
        ...
        <tr bgcolor=#EBEFF5>
  		...
  		<td colspan="9"><input id="opinion" name="opinion" class="mini-textarea" width="100%" enabled="false" height="70px" emptyText="请输入意见" value="${checkout.opinion }"></td>
  		</tr>
   		</table>
   		
   		<div id="grid1" class="mini-datagrid" style="width:99%;height:95%;"
    	 borderStyle="border:0;" multiSelect="true"  idField="id" showSummaryRow="true" allowAlternating="true" showPager="true"
		url="seeDetailCheckoutServlet?checksheet_id=${checkout.checksheetId}">
        <div property="columns">
            ...
            <div field="purductNum"  headerAlign="center" align="center">订单总数</div>
            <div field="alreadyPayNum"  headerAlign="center" align="center">已交付数量</div>
            <div field="noPayNum"  headerAlign="center" align="center">未交付数量</div>
            <div field="checkoutNum" headerAlign="center" align="center">本次出库数量</div>
	    ...
	    function printCheckout(){
	    	var sheetId=mini.get("checksheet_id").getValue();
      		window.open("printCheckoutServlet?sheetId="+sheetId,
	                "editwindow","top=50,left=100,width=1000px,height=400px,status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=yes");
