  ...
  <body>
    <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
        ...
        <div property="columns">
            ...
            <div field="drawingId" width="100" headerAlign="center">产品号</div>
            ...
            -->
            <div name="paper" width="100" headerAlign="center" align="center" renderer="onPaperDownload"
                 cellStyle="padding:0;">图纸
            </div>
            <!--
    ...
    <script type="text/javascript">
	    ...
	    function onOperatePower(e) {
	        var str = "";
	        str += "<span>";
	        str += "<a style='margin-right:2px;' title='编辑' href=javascript:ondEdit(\'" + e.row.orderId+"\',\'"+e.row.productId + "\') ><span class='mini-button-text mini-button-icon icon-node'>&nbsp;</span></a>";
	        str += "</span>";
	        return str;
	    }
	    
	    function onPaperDownload(e) {
	    	var paper = e.row.paper;
	    	var str = "";
	    	if(""==paper||null==paper||undefined==paper){
	    		...
	    		str += "<span>";
	        	str += "<a style='margin-right:2px;' title='点击下载图纸' href='DownLoadOrderFileServlet?filename="+paper+"'>"+e.row.paper+"</a>";
	        	str += "</span>";
	    	}
	        return str;
	    }
	    ...
	    function ondEdit(orderId,productId){
	    	...
	    	window.location="CheckOrderDetailSpecServlet?orderId=" + orderId+"&productId="+productId;
		}
