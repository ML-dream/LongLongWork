	...
	<body style="height: 100%;">
		<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    <div showHeader="false" region="west" width="180" maxWidth="250" minWidth="100" >
		        ...
		        <ul id="leftTree" class="mini-tree" url="GetOrderTreeServlet" style="width:100%;height:95%;" 
                    showTreeIcon="true" textField="text" idField="id" resultAsTree="false"  
                    onnodeselect="onNodeSelect"  >        
                </ul>
		    </div>
		    <div title="center" region="center" bodyStyle="overflow:hidden;">
		        <iframe id="mainframe" frameborder="0" name="main" style="width:100%;height:100%;" src="orderManage/OrderAllStatusList.jsp" border="0"></iframe>
		    </div>
		</div>
		<script>
			mini.parse();
