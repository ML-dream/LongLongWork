	...
	<body style="height: 100%;">
		...
		<script>
	        ...
	        function onNodeSelect(e) {
	        	...
	        	if(node.level==2){			//零件层
	        		var a = "BaseServlet?meth=GoCraftMainBody&pathTo=mainBody&orderId="+node.orderId+"&productId="+node.id+"&FProductId="+node.pid+"&isLeaf="+isLeaf+"&issueNum="+node.issueNum+"&drawingId="+node.drawingId;
	        		iframe.src = encodeURI(a);
	        		// alert(node.id);
