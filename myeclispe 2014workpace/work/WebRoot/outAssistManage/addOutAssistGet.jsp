  ...
  <body>
	...
	<fieldset style="width: 99%;" align="center">
       ...
       <tr>
	        ...
	        <td><input id="getNum" name="getNum" class="mini-textbox" width="100%" vtype="int" required="true" /></td>
   			<td><label for="numUnit$text">单位</label></td>
            <td><input id="numUnit" name="numUnit" class="mini-textbox" width="100%" required="true" /></td>
		</tr>
   		<tr>
   			<td><label for="getDate$text">收货日期</label></td>
            <td><input id="getDate" name="getDate" class="mini-datepicker" width="100%" allowInput="false"
            ...
            <td><input id="getPerson" name="getPerson" class="mini-buttonedit" width="100%" 
   ...
   <script>
   		...
   		function getForm(){
            ...
            if (form.isValid() == false) {
                ...
                var url = 'AddOutAssistGetServlet';
   	...
   	//验证QQ号码5-11位
        ...
        mini.get("itemName").value = decodeURI(Request['itemName']);
