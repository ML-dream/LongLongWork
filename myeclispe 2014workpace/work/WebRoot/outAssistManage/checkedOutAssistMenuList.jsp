...
<html>
  ...
  <body>
    ...
    <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
         ...
         url="CheckedOutAssistMenuListServlet" allowCellSelect="true" allowCellEdit="true">
        <div property="columns">
            ...
            <div field="companyName" width="30" headerAlign="center">外协单位
            </div> 
            ...
            <div field="outAssistStatus" width="20" headalign="center"  renderer="onGenderRenderer">状态
              <input property="editor" class="mini-combobox"  width="100%" url="data/OutAssistStatus.txt" readonly />
            </div>
       </div>
     </div>
...
//          str += "</span>";
		...
		function ondMenu(menuId,waiXieCom,companyName){
	    	window.location="GoOutAssistMenuServlet?menuId="+menuId+"&waiXieCom="+waiXieCom+"&companyName="+companyName;
		}
