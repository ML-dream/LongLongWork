  ...
  <body>
  	...
  	<div class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;"> 
	        ...
	        <div id="grid1" class="mini-datagrid" style="width:100%;height:320px;"
				         ...
				         url="NoticeListServlet?isReaded=1" onrowdblclick="rowdblclick">
				        <div property="columns">
				            ...
				            <div field="sender" width="15%" headerAlign="center">发送人</div>
				            <div field="receiver" width="15%" headerAlign="center">接收人</div>
				            <div field="sendTime" width="15%" headerAlign="center" dateFormat="yyyy-MM-dd HH:mm:ss">发送时间</div>
				            <div field="readTime" width="15%" headerAlign="center" dateFormat="yyyy-MM-dd HH:mm:ss">查看时间</div>
