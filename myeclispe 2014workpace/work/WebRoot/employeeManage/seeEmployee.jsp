 ...
 --><fieldset style="width: 100%;" align="center">
   	...
   	<div id= "userdiv">
   		...
   		<tr>
            ...
            <td><input id="staffCode"  name="staffCode" class="mini-textbox" width="100%"   value="${employee.staffCode}" readonly/></td>
   			<td><label for="staffName$text">员工姓名*</label></td>
            <td><input id="staffName"  name="staffName" class="mini-textbox"  width="100%"   value="${employee.staffName} " readonly/></td>
   			<td><label for="sectionCode$text">所属部门*</label></td>
            <td><input id="sectionCode" name="sectionCode" class="mini-buttonedit" width="100%" onbuttonclick="onButtonEdit" readonly value="${employee.sectionName}" text="${employee.sectionName}"/></td>
    ...
    <!--      	<td><input id="birthday" name="birthday" class="mini-textbox" width="100%"   emptyText="日期格式：2000-01-01"  vtype="date:yyyy-MM-dd" required="true" value="${employee.birthday}" enabled="false"/></td> -->  
            <td><input id="birthday" name ="birthday" class="mini-datepicker" width="100%" dateFormat="yyyy-MM-dd" readonly value="${employee.birthday}"/></td>
       </tr>
       <tr>
          	<td><label >性别* </label></td>
          	<td><div id="gender" name="gender" class="mini-radiobuttonlist" 
              repeatItems="2" repeatDirection="" repeatLayout="table" url="data/sexs.txt" textField="text" valueField="id"  value="${employee.gender}" readonly></div>
          	</td> 
			<td><label for="IDCard$text">身份证号*</label></td>
	        <td><input id="IDCard"  name="IDCard" class="mini-textbox" width="100%"  onvalidation="onIDCardsValidation" readonly  value="${employee.IDCard}" /></td>
            ...
            <td><input id="educationLevel"  name="educationLevel" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/educationLevel.txt" readonly  showNullItem="true" nullItemText="请选择..."  value="${employee.educationLevel}"/>  
    		<td><label for="mobilePhone$text">手机号*</label></td>
	        <td><input id="mobilePhone"  name="mobilePhone" class="mini-textbox" width="100%" onvalidation="isMobile"readonly  value="${employee.mobilePhone}"/></td>
	...
	<!--     <td><input id="joinTime"  name="joinTime" class="mini-textbox" width="100%"  emptyText="日期格式：2000-01-01"  vtype="date:yyyy-MM-dd" required="true"  value="${employee.joinTime}"/></td>  -->     
	        <td><input id="joinTime" name ="joinTime" class="mini-datepicker" width="100%" dateFormat="yyyy-MM-dd" readonly  value="${employee.joinTime}"/></td>
	        <td><label for="position$text">职位</label></td>
            <td><input id="position"  name="position" class="mini-textbox"  width="100%"  readonly value="${employee.position}"/></td>
             <td><label for="workTime$text">工作年限</label></td>
            <td><input id="workTime"  name="workTime" class="mini-textbox"  vtype="range:0,99" width="100%"  readonly value="${employee.workTime}"/></td>
   			<td><label for="fee$text">工资/月</label></td>
            <td><input id="fee"  name="fee" class="mini-textbox" width="100%"    emptyText="请输入工资"  vtype="float"  readonly value="${employee.fee}"/></td>	
   		</tr>
   		<tr>
            ...
            <td><input id="workType"  name="workType" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="LoadWorkType" value="${employee.workType}"  readonly  showNullItem="true" nullItemText="请选择..."/> 
            </td>
   			<td><label for="technicalGrade$text">技术等级</label></td>
            <td><input id="technicalGrade"  name="technicalGrade" class="mini-textbox" width="100%"    value="${employee.technicalGrade}" readonly/></td>
   			<td><label for="officePhne$text">办公室电话</label></td>
            <td><input id="officePhne"  name="officePhne" class="mini-textbox" width="100%" value="${employee.officePhne}" readonly/></td>
            <td><label for="address$text">地址</label></td>
            <td><input id="address"  name="address" class="mini-textbox" width="100%"    value="${employee.address}" readonly/></td>
   			
   		</tr>
   		<tr>
   		    <td><label for="homePhone$text">家庭电话</label></td>
            <td><input id="homePhone"  name="homePhone" class="mini-textbox" width="100%" value="${employee.homePhone}" readonly/></td>
            <td><label for="speciality$text">特长爱好</label></td>
            <td><input id="speciality"  name="speciality" class="mini-textbox"  width="100%" value="${employee.speciality}" readonly/></td>
            </td><td><label for="schoolFrom$text">毕业院校</label></td>
            <td><input id="schoolFrom"  name="schoolFrom" class="mini-textbox"  width="100%"   value="${employee.schoolFrom}" readonly/></td>
   			<td><label for="RFIDCode$text">RFID号码</label></td>
            <td><input id="RFIDCode"  name="RFIDCode" class="mini-textbox" width="100%"  value="${employee.RFIDCode}" readonly/></td>
        </tr>
        
        <tr>
   			<td><label for="QQ$text">QQ</label></td>
            <td><input id="QQ"  name="QQ" class="mini-textbox" width="100%"     value="${employee.QQ}" readonly/></td>
   			<td><label for="email$text">邮箱</label></td>
            <td><input id="email"  name="email" class="mini-textbox"  width="100%" vtype="email"   value="${employee.email}" readonly/></td>
     ...
     <!--   <td><input id="leaveTime"  name="leaveTime" class="mini-textbox" width="100%"  emptyText="日期格式：2000-01-01" value="${employee.leaveTime}"/></td> -->       
            <td><input id="leaveTime" name ="leaveTime" class="mini-datepicker" width="100%" dateFormat="yyyy-MM-dd" allowInput="true" value="${employee.leaveTime}" readonly/></td>
   		</tr>
   	</table>
   </div>
   </fieldset>
