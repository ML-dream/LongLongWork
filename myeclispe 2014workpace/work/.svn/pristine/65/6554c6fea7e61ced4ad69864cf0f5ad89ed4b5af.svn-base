...
public class getCheckinFormServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(isson){
     	...
     	String sql="select B.orderid,B.productid,B.issuenum,C.product_name,C.spec,C.drawingid,C.producttype," +
				"E.item_typedesc productTypeDesc,C.unitprice unitPrice from partsplan B " +
...
//安顺        
       /*String sql = "select B.order_id orderID,B.product_id productId,B.issue_num issueNum,B.product_name," +
       		"B.spec,B.drawingid,B.producttype,E.item_typedesc productTypeDesc,B.unitprice unitPrice " +
       		"from order_detail B left join itemtype E on E.item_typeid=B.producttype " +
       		"where B.barcode='"+codeId + "'";*/
