		...
		//  点击行事件 
   		...
   		function doB(doingtype){
		    ...
		    var drawingId = document.getElementById("drawingId").innerHTML;
   			...
   			if(doingtype == "addfo"){
   				var a = "BaseServlet?meth=GetFoHeader&pathTo=foHeader&orderId="+orderId+"&productId="+productId+"&FProductId="+fproductId+"&isHere=0";
		    	document.getElementById("subIframe").src=encodeURI(a);
