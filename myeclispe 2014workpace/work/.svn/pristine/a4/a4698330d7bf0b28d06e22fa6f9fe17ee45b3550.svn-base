...
<html>
  ...
  <body>
    ...
    <div class="mini-toolbar" style="width:900px;padding:2px;border:0;">
    ...
    <div id="grid1" class="mini-treegrid" style="width:900px;height:480px;"  borderStyle="border:0;" allowResize="true"
    	url="ProductSumDetail?productId=${productId}&orderId=${orderId}" 
	...
	>
        <div property="columns">
            ...
            <div field="fono"  width="100" headerAlign="center">工序
            </div>
            <div field="foopname" name="productName" width="100" headerAlign="center">工序名称
            </div>
            <div field="acceptnum" width="50" headerAlign="center">合格数
            </div>
            <div field="rejectnum" width="50" headerAlign="center">废品数
            </div>
            <div field="fixnum" width="50" headerAlign="center">返修数
            </div>
        </div>
    </div>
