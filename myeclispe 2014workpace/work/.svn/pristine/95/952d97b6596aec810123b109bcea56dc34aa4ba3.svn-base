...
<!--  		-->
 	...
 	<tr bgcolor=#EBEFF5>
  	...
  	<td colspan="5"><input id="opinion" name="opinion" class="mini-textarea" width="100%" required="true" enabled="false" height="100px" emptyText="请输入备注" value="${poplan.opinion }"></td>
  	</tr>
  	</table>
  </form>
  
  <div id="grid1" class="mini-datagrid" style="width:99%;height:75%;" borderStyle="border:0;" multiSelect="true" ondrawsummarycell="onDrawSummaryCell"
     idField="id" showSummaryRow="true" allowAlternating="true" showPager="true" url="ShowPoDetailServlet?po_sheetid=${poplan.posheetid }">
     	<div property="columns">
            ...
            <div field="unit" headerAlign="center" align="center" width="5%" >单位</div>
            ...
            <div field="price" headerAlign="center" align="center" width="10%">货款</div>
