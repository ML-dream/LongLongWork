...
<div style="width:600px; margin:0 auto; border:2px solid #6D6D6D;">
	...
	<table>
		<tr>
 			...
 			<td><a id="print" class="mini-button" iconCls="" onclick="printState()">打印</a> </td>
 		</tr>
	</table>
<form id="form1">
	<table>
...
<form id="form2">	
	<div class="describle" style="height:160px;">
		...
		<a id="opinionerbutton" class="mini-button" iconCls="" onclick="checkerUp">提交</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="other">
		...
		<textarea id="securityin" name="securityin" class="mini-textarea" width="100%" height="50%" emptyText="请输入备注" enabled="true"></textarea>
		</br>
		<span class="sign"><label>生产安全部负责人</label>
		<input id="security" name="security" class="mini-textbox" enabled="false"/> </span>
		<a id="securitybutton" class="mini-button" iconCls="" onclick="submit('security')">提交</a>
	</div>
	
	<div class="other">
		<label>对产品使用性能影响的分析（仅适合自己设计生产）</label> </br>
		<textarea id="designerin" name="designerin" class="mini-textarea" width="100%" height="50%" emptyText="请输入备注" enabled="true"></textarea>
		</br>
		<span class="sign"><label>产品主管工艺员</label>
		<input id="designer" name="designer" class="mini-textbox" enabled="false"/></span>
		<a id="designerbutton" class="mini-button" iconCls="" onclick="submit('designer')">提交</a>
	</div>
	
	<div class="other">
		<label>市场推广部意见（仅适合外协加工产品）</label> </br>
		<textarea id= "marketerin" name="marketerin"class="mini-textarea" width="100%" height="50%" emptyText="请输入备注" enabled="true"></textarea>
		</br>
		<span class="sign"><label>市场推广部主任</label>
		<input id="marketer" name="marketer" class="mini-textbox" enabled="false"/></span>
		<a id="marketerbutton" class="mini-button" iconCls="" onclick="submit('marketer')">提交</a>
	</div>
	
	<div class="other">
		<label>对纠正预防措施有效性的督察检查</label> </br>
		<textarea id="superviserin" name="superviserin" class="mini-textarea" width="100%" height="50%" emptyText="请输入备注" enabled="true"></textarea>
		</br>
		<span class="sign"><label>品质部负责人</label>
		<input id="superviser" name="superviser" class="mini-textbox" enabled="false"/></span>
		<a id="superviserbutton" class="mini-button" iconCls="" onclick="submit('superviser')">提交</a>
	</div>
	
	<div class="other" style="height:150px">
		<label>审理意见</label> 
		<div id="opinion" name="opinion" class="mini-radiobuttonlist" repeatItems="1" repeatLayout="table" repeatDirection="vertical"
				    textField="text" valueField="id" value="empty"
				    url="qualitycheck/json/opinion.txt" >
		</div>
		<textarea id="opinionText" name="opiniontext" class="mini-textarea" width="100%" height="40%" emptyText="请输入备注" enabled="true"></textarea>
		</br>
		<span class="sign"><label>主管领导</label>
		<input id="opinioner" name="opinioner" class="mini-textbox" enabled="false"/></span>
		<a id="opinionerbutton" class="mini-button" iconCls="" onclick="opinioner('0')">提交</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a id="opinionerbutton2" class="mini-button" iconCls="" onclick="opinioner('1')">修改意见</a>
	...
	<div class="other">
		...
		<textarea id="recheckerin" name="recheckerin" class="mini-textarea" width="100%" height="50%" emptyText="请输入备注" enabled="true"></textarea>
		</br>
		<span class="sign">
		<label>检验员</label>
		<input id="rechecker" name="rechecker" class="mini-textbox" enabled="false"/></span>
		<a id="recheckerbutton" class="mini-button" iconCls="" onclick="submit('rechecker')">提交</a>
	</div>
</form>	
	<div style="margin: auto auto auto 140px;">
		<a id="fixtable" class="mini-button" iconCls="" onclick="fixtable('toFix')" >返修单</a>
		<a id="discardtable" class="mini-button" iconCls="" onclick="discardtable('toDiscard')">报废单</a>
		<!-- <a id="oversizetable" class="mini-button" iconCls="" onclick="oversizetable">超差记录</a>  -->
		<a id="newbarcode" class="mini-button" onclick="showNbarcode()" style="color:red;" >打印流程卡</a>
		<a id="fixtable" class="mini-button" iconCls="" onclick="seefixtable()">查看返修单</a>
		<a id="discardtable" class="mini-button" iconCls="" onclick="seediscardtable()">查看报废单</a>
	</div>
</div>
...
<script type="text/javascript">
    ...
    function checkerUp(){
    	...
    	data.cardType = "submit";		//审理单类型，返修还是上报 
   ...
   function onButtonEdit2(e) {
     ...
     function printState(){
     	var runnum = mini.get("runNum").getValue();
   		window.open("ShowStateJudge?runnum=" + runnum,
	                "editwindow","top=50,left=100,width=950px,height=400px,status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=yes");
     }
</script>
</html>