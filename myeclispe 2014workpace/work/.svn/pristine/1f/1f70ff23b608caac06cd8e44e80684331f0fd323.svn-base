...
<html>
  ...
  <div class="mini-toolbar">
   ...
   <fieldset style="width: 99%;height:99%;" align="center">
		<legend>
			产品信息
		</legend> 
   	<form name="userdiv" id="userdiv" action="AddOrderServlet" method="post" enctype="multipart/form-data">
   		...
   		<tr>
            ...
            <td><input id="orderId"  name="orderId" class="mini-textbox"  width="100%"  value="${order.orderId}" readonly/></td>
            ...
            <td><input id="productId" name="productId" class="mini-buttonedit" width="100%" 
   			 ...
   			 -->
   			<td><input id="productId"  name="productId" class="mini-textbox"  width="100%"  value="${order.productId}" readonly/></td>
            <td><label for="productName$text">产品名称*</label></td>
            <td><input id="productName"  name="productName" class="mini-textbox"  width="100%"  value="${order.productName}" readonly/></td>
       </tr>
       <tr>
   			<td><label for="FProductId$text">父产品号*</label></td>
            <td><input id="FProductId"  name="FProductId" class="mini-textbox"  width="100%"  value="${order.fproductId}" readonly/></td>
            <td><label for="issueNum$text">版本号*</label></td>
            <td><input id="issueNum"  name="issueNum" class="mini-textbox"  width="100%"  value="${order.issueNum}" readonly/></td>
            <td><label for="productNum$text">产品数量*</label></td>
       		<td><input id="productNum"  name="productNum" class="mini-textbox"  width="100%" value="${order.productNum}" readonly/></td>


       </tr>
       <tr> 
            <td><label for="unitPrice$text">单价*</label></td>
        	<td><input id="unitPrice"  name="unitPrice" class="mini-textbox"  width="100%"  value="${order.unitPrice}" readonly/></td> 
            ...
            <td><input id="islailiao"  name="islailiao" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/islailiao.txt"  allowInput="false" showNullItem="true" nullItemText="请选择..." value="${order.isLaiLiao}" readonly/>  
            </td>  
            <td><label for="material$text">材料</label></td>
            <td><input id="material"  name="material" class="mini-combobox" data="" url= "LoadStuff" width="100%"  value="${order.material}" readonly/></td> 
       </tr>
       <tr>            
            ...
            <td><input id="iswaixie"  name="iswaixie" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/trueOrFalse.txt"  allowInput="false" showNullItem="true" nullItemText="请选择..." value="${order.isWaiXie}" readonly/>  
            </td>
            ...
            <td><input id="itemTypeId"  name="itemTypeId" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="GetItemTypeServlet" value="${order.productType}"  allowInput="false" showNullItem="true" nullItemText="请选择..." readonly/> 
            <td><label for="drawingId$text">产品号</label></td>
        	<td><input id="drawingId"  name="drawingId" class="mini-textbox"  width="100%" value="${order.drawingId}" readonly/></td>
        </tr>
       <tr>       	
        	<td><label for="spec$text">产品规格</label></td>
            <td><input id="spec"  name="spec" class="mini-textbox"  width="100%"  value="${order.spec}" readonly/></td>
            <td><label for="lot$text">批次</label></td>
        	<td><input id="lot"  name="lot" class="mini-textbox"  width="100%" value="${order.lot }" readonly/></td>
            ...
            <td><input id="deptNo"  name="deptNo" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/dept.txt"  allowInput="false" showNullItem="true" nullItemText="请选择..." value="${order.deptId}" readonly/>  
            </td>
            
         </tr>
       <tr>          
            <td><label for="BTime$text">开始时间</label></td>
            <td><input id="BTime"  name="BTime" class="mini-textbox"  width="100%"   emptyText="日期格式：2000-01-01" value="${order.bTime}" readonly/></td>
            <td><label for="ETime$text">结束时间</label></td>
            <td><input id="ETime"  name="ETime" class="mini-textbox"  width="100%"   emptyText="日期格式：2000-01-01" value="${order.eTime}" readonly/></td>  
            </td>
            <td>下载图纸</td>
       ...
       <tr>		
   	   ...
   	   <tr height="60px;">
	        ...
	        <td colspan="5"><input id="memo"  name="memo" class="mini-textarea" emptyText="请输入备注"  width="100%" height="100%" value="${order.memo}" readonly/></td>
       </tr>
   	</table>
   </form>
   </fieldset>
   <div id="grid1" class="mini-datagrid" width="100%" height="220px"  
        url="ShowSelectedQuotationProductServlet?orderId=${order.orderId}&productId=${order.productId}&fproductId=${order.fproductId}&issueNum=${order.issueNum}" idField="id" 
    ...
    >
        <div property="columns">
            ...
            <div field="addPrice" width="100" headerAlign="center"  >实报单价</div>
            <div field="unit" width="60" headerAlign="center">单位</div>
            <div field="totalTime" width="100" headerAlign="center">实报工时</div>
