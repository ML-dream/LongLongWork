...
<html>
  ...
  <body>
	    ...
	    <table >
	       ...
	       <tr>
	          ...
	          <td colspan="2"><input id="customer" name="creater" class="mini-buttonedit" width="100%" showClose="true" oncloseclick="onCloseClick('customer')"
	   		...
	   		<tr>
	   			<!--<td>是否超期：</td>
		        <td><input id="isExceed" name="isExceed" class="mini-combobox" width="100" textName="" textField="text" valueField="id"
	  				url="data/isExceed.txt"  allowInput="false" showNullItem="true" nullItemText="请选择..."  onvaluechanged="loadgrid" value="1"/>
		        </td>
    ...
    <div id="grid1" class="mini-datagrid" style="width:98%;height:90%;"  showColumnsMenu ="true" 
        ...
        <div property="columns">
            ...
            <div field="companyName" width="100" headerAlign="center" visible="false">客户名称
            </div>
            <div field="connector" width="50" headerAlign="center"  visible="false">联系人
            </div>
            <div field="connectorTel" width="60" headerAlign="center"  visible="false">联系人电话
            </div>
            <div field="deptUser" width="50" headerAlign="center" renderer="onDeptRenderer"  visible="false">使用部门
            </div>
            <div field="orderDate" width="80" headerAlign="center" dateFormat="yyyy 年 MM 月 dd 日"  visible="false" >订单日期
            </div>
            ...
            <div field="createPerson" width="50" headerAlign="center"  visible="false">接收人
            </div>
            <div field="orderPrice" width="70" headerAlign="center"  visible="false">订单总价
            </div>
            <div field="isExceed" width="20" headerAlign="center"  visible="true" renderer="onExceedRenderer" >是否超期
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
	   ...
	   function onDrawSummaryCell(e) {
	    ...
	    function loadgrid(){
	    	...
	    	var isExceed = mini.get("isExceed").getValue();
	    	grid.load({bday:bday, eday:eday, creater:creater, status:status, customer:customer, isExceed:isExceed});
	    }
      ...
      function onButtonEdit2(e) {
	    ...
	    function ondSee(orderId){
	    	//var bday = mini.get("bday").getFormValue();
	    	//var eday = mini.get("eday").getFormValue();
	    	window.location="ProductSum?orderId="+orderId;
		}
        ...
        var dept = [{id:"0",text:"超期"},{id:"1",text:"正常"}];
        function onExceedRenderer(e) {
        	if (e.value<0) {
        		return dept[0].text;}
        	else {
        		return dept[1].text;}
