...
public class addDataMaintenanceServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public addDataMaintenanceServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql="insert into paystatistics (maintenancedate,companyid,beginPayment,sale,thispayment,endpayment) " +
