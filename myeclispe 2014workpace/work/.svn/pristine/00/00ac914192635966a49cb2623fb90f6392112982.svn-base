...
import com.xm.testaction.qualitycheck.sum.EmpRejectSum;
import com.xm.testaction.qualitycheck.sum.SumByEmpBean;
import com.xm.testaction.qualitycheck.sum.SumByEmpClose;

public class empSumExcelOut extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public empSumExcelOut() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(this.getClass().getName());	//员工生产状况统计导出
...
//			"a.fixnum,a.discardnum,a.ratedtime*a.donenum ratedtime,a.donetime,(a.donetime - a.ratedtime*a.donenum) timegap,a.discardtime,round((a.discardtime/a.donetime*100),2) timeper,a.fixtime,rownum rn  " +
		...
		liebiaoxiang.put("staff_code", "员工编号");
		liebiaoxiang.put("staff_name", "员工姓名");
		liebiaoxiang.put("deptname", "所属部门");
		
		liebiaoxiang.put("donenum", "完成数量");
		liebiaoxiang.put("acceptnum", "合格数");
		liebiaoxiang.put("fixnum", "返修数");
		liebiaoxiang.put("discardnum", "报废数");
		liebiaoxiang.put("rejectper", "次品率");
		
		liebiaoxiang.put("ratedtime", "计划工时");
		liebiaoxiang.put("donetime", "完成工时");
		liebiaoxiang.put("timegap", "工时差额");
		liebiaoxiang.put("fixtime", "返修质量损失");
		liebiaoxiang.put("discardtime", "报废质量损失"); 
