...
public class TlData {
	public static void getTlData(HttpServletRequest request,HashMap datamap,String rm_sheetid,String item_id1,String item_name1,
		...
		try{
			...
			Stockcl.Stockin(request,item_id,item_name,spec,item_type,warehouse_id,stock_id,rm_num,unitprice,unit);
