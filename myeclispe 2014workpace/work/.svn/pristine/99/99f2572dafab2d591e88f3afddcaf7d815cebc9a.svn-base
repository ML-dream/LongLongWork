...
<html>
  ...
  allowInput="false" required="true" enabled="false" value="${llsheet.warehouseId }" text="${llsheet.warehouseName }"/></td>
   </tr> 
   </table> 
   </div>
    ...
    <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
        ...
        <div property="columns">
          ...
          <div field="itemName" width="80" headerAlign="center" align="center">物料名称
            ...
            <div field="productName" width="80" headerAlign="center" align="center">产品名称
            </div>
...
<!--            </div>-->
  ...
  allowInput="false" required="true" enabled="false" value="${llsheet.empId }" text="${llsheet.empName }"></td>
   <td><lable for="dept$text">所属部门</lable></td>
   <td><input id="dept" name="dept" class="mini-textbox" width="100%" required="true" enabled="false" value="${llsheet.dept }"></td>
   ...
   allowInput="false" required="true" enabled="false" value="${llsheet.operatorId }" text="${llsheet.operatorName }"></td>
   </tr> 
   </table>
   </div>
    </fieldset> 
