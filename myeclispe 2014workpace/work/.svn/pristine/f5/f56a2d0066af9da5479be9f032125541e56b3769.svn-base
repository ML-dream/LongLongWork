...
public class LingliaoSum extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int totalCount = 0;
		String conditon = HelpSumExcel.conditonSql(request, response);
		if(!conditon.equals("noEntry")){
			String totalCountSql = "select count(*) from lingliao_detl t " +
			"left join lingliao a on  a.ll_sheetid=t.ll_sheetid "+conditon;
