...
<html>
  ...
  <body>
    <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
         ...
         url="jianceServlet?flag=<%=request.getAttribute("flag") %>&orderId=<%=request.getAttribute("orderId") %>&itemId=<%=request.getAttribute("itemId") %>">
    ...
    <script type="text/javascript">
	    ...
	    grid.load();
	    window.setInterval(function(){grid.load()},15000);
	    //alert("dddd");
    </script>
  </body>
</html>
