...
<!--  <span class="separator"></span>-->
   ...
   <form id="datepicker" action="" method="post">
  	...
  	<div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
         ...
         url="showPaySheetServlet" >
        <div property="columns"> 
            <div type="indexcolumn">序号</div>
            <div field="companyName"  headerAlign="center" align="center">供应商</div>
            <div field="payDate" headerAlign="center" align="center" dateFormat="yyyy-MM-dd">回款日期</div>
            <div field="thisPaid"  headerAlign="center" align="center">付款金额</div>
            <div field="qualitykk" headerAlign="center" align="center">质量扣款</div>
