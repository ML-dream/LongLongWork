	...
	<fieldset style="width: 99%;" align="center">
   	...
   	<div id= "userdiv">
   		...
   		<tr>
            ...
            <td><input id="orderId"  name="orderId" class="mini-textbox" width="100%" enabled="false" required="true"/></td>
   			<td><label for="itemId$text">零部件号</label></td>
            <td><input id="itemId"  name="itemId" class="mini-textbox"  width="100%" required="true" /></td>
   			...
   			<!--
            <td><input id="itemName"  name="itemName" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
       ...
       <tr>
            ...
            <td><input id="drawingId"  name="drawingId" class="mini-textbox" width="100%" required="true"/></td>
            <td><label for="num$text">数量</label></td>
	        <td><input id="num"  name="num" class="mini-textbox" width="100%" vtype="int" required="true" onBlur="getPrice()"/></td>
   			<td><label for="numUnit$text">单位</label></td>
            <td><input id="numUnit"  name="numUnit" class="mini-textbox" width="100%" vtype="maxLength:16" required="true" /></td>
		</tr>
   		<tr>
   			<td><label for="unitPrice$text">单价</label></td>
            <td><input id="unitPrice"  name="unitPrice" class="mini-textbox" width="100%" vtype="float" required="true" onBlur="getPrice()"/></td>
   			<td><label for="startDate$text">下单时间</label></td>
   			<td><input id="startDate"  name="startDate" class="mini-datepicker" width="100%" allowInput="false"  value="${result.trueEndDate}"
   			...
   			<td><input id="planEndDate"  name="planEndDate" class="mini-datepicker" width="100%" allowInput="false"  value="${result.trueEndDate}"
	   				dateFormat="yyyy-MM-dd  HH:mm:ss" format="yyyy-MM-dd" showTime="false" showOkButton="false" showClearButton="false" required="true"/>
	   		</td>
        </tr>
   		<tr>
   			<td><label for="endDate$text">收货时间</label></td>
   			<td><input id="endDate"  name="endDate" class="mini-datepicker" width="100%" allowInput="false"  value="${result.trueEndDate}"
            ...
            <td><input id="totalPrice"  name="totalPrice" class="mini-textbox" width="100%" vtype="float" enabled="false"/></td>
   		</tr>
   		<tr height="60px;">
   			<td><label for="detail$text">加工内容</label></td>
            <td colspan="5"><input id="detail" name="detail" class="mini-textarea" emptyText="请输入加工内容" 
   ...
   <script>
   		...
   		function getForm(){
            ...
            if (form.isValid() == false) {
                ...
                var url = 'AddOutAssistDetailServlet';
   	    ...
   	    function getPrice(){
   	    	var num = mini.get("num").value;
   	    	var unitPrice = mini.get("unitPrice").value;
   	    	if(num!=undefined&&num!=""&&unitPrice!=""&&unitPrice!=undefined){
   	    		mini.get("totalPrice").setValue(parseFloat(num)*parseFloat(unitPrice));
   	    	}
   	    }
