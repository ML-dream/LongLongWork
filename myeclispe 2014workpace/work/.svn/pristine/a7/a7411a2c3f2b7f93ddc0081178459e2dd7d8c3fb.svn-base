...
public class addSupplierServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    String companyName = datamap.get("companyName").toString().trim();
	    ...
	    String header = datamap.get("header").toString().trim();
	    String employeeNum = ChineseCode.toUTF8(datamap.get("employeeNum").toString().trim());
	    
	    String address = datamap.get("address").toString().trim();
	    ...
	    String connector =datamap.get("connector").toString();
