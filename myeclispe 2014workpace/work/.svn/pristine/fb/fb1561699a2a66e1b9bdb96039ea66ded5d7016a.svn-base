...
<html>
  ...
  <body style="height:100%;">
    <div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    <div showHeader="false" region="west" width="250" maxWidth="300" minWidth="150" >
		    	<a class="mini-button" iconCls="icon-reload" plain="false" onclick="refresh()" >刷新</a>
		        <ul id="leftTree" class="mini-tree" url="GetCustomerPayTreeServlet" style="width:100%;height:95%;" 
                    showTreeIcon="true" textField="text" idField="id" parentField="pid" resultAsTree="false"  
                    onnodeselect="onNodeSelect" >        
                </ul>
		    </div>
		    <div title="center" region="center" bodyStyle="overflow:hidden;">
		        <iframe id="mainframe" frameborder="0" name="main" style="width:100%;height:100%;" src="payMent/payRecordQueryList.jsp" border="0"></iframe>
		    </div>
		</div>
		<script> 
			mini.parse();
	        ...
	        function onNodeSelect(e) {
		       ...
		       // }	
        		...
        		iframe.src = "getPayCompanyIdServlet?companyId="+node.id;
		        }
	        	if(node.level==2){			//零件层
