  ...
  <body>
	...
	<fieldset style="width: 100%;" align="center">
		<legend>
   		...
   		<tr>
            ...
            <td><input id="orderId" name="orderId" class="mini-textbox" visible="false" value="${item.orderId}"/>
            	<input id="itemId"  name="itemId" class="mini-textbox"  width="100%" required="true"  value="${item.itemid}"/></td>
            ...
            <td><input id="itemTypeId"  name="itemTypeId" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="GetItemTypeServlet" value="L"  required="true" allowInput="false" showNullItem="true" nullItemText="请选择..."  value="${item.itemtypeid}"/>  
            </td>
            <td><label for="itemName$text">物料名称</label></td>
            <td><input id="itemName"  name="itemName" class="mini-textbox"  width="100%" required="true"  value="${item.itemname}"/></td>
        </tr>
       	<tr>
            <td><label for="itemDrawing$text">图号</label></td>
            <td><input id="itemDrawing"  name="itemDrawing" class="mini-textbox"  width="100%" required="true"  value="${item.itemdrawing}"/></td>
            <td><label for="FItemId$text">父物料</label></td>
            <td><input id="purchaseUnite"  name="purchaseUnite" class="mini-textbox"  width="100%" required="true"  value="${item.fitemid}"/></td>
            <!-- 
            <td><input id="FItemId" name="FItemId" class="mini-buttonedit" width="100%" onbuttonclick="onButtonEdit" 
            textName="companyName" required="true" allowInput="false" text="${item.fitemid}" value="${item.fitemid}"/></td>
            ...
            <td><input id="itemSpecification"  name="itemSpecification" class="mini-textbox"  width="100%" required="true"  value="${item.itemspecification}"/></td>
        </tr>
        <tr>    
            <td><label for="purchaseUnite$text">采购单位</label></td>
            <td><input id="purchaseUnite"  name="purchaseUnite" class="mini-textbox"  width="100%" required="true"  value="${item.purchaseunite}"/></td>
            <td><label for="itemPrice$text">物料价格</label></td>
            <td><input id="itemPrice"  name="itemPrice" class="mini-textbox"  width="100%" required="true" vtype="range:0,99999999" value="${item.itemprice}"/></td>
            ...
            <td><input id="priceUnit"  name="priceUnit" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/priceUnit.txt" required="true" allowInput="false" showNullItem="true" nullItemText="请选择..." value="${item.priceunit}"/>  
            </td>
        </tr>
       	<tr>  
       		<!-- 
            ...
            <td><input id="materialMark"  name="materialMark" class="mini-textbox"  width="100%"  value="${item.materialmark}"/></td> 
       		<td><label for="itemAttri$text">物料属性</label></td>
            <td><input id="itemAttri"  name="itemAttri" class="mini-textbox"  width="100%" value="${item.itemattri}"/></td>   
            <td><label for="lotSize$text">批量大小</label></td>
            <td><input id="lotSize"  name="lotSize" class="mini-textbox"  width="100%" value="${item.lotsize}"/></td>  
        </tr>
       	<tr>
            <td><label for="leadTime$text">提前期</label></td>
            <td><input id="leadTime"  name="leadTime" class="mini-textbox"  width="100%"  value="${item.leadtime}"/></td>
            <td><label for="safeStock$text">安全库存</label></td>
            <td><input id="safeStock"  name="safeStock" class="mini-textbox"  width="100%" value="${item.safestock}"/></td>
            <td><label for="stockLow$text">最低库存</label></td>
            <td><input id="stockLow"  name="stockLow" class="mini-textbox"  width="100%" value="${item.stocklow}"/></td>
        </tr>
       	<tr>
            <td><label for="stockHigh$text">最高库存</label></td>
            <td><input id="stockHigh"  name="stockHigh" class="mini-textbox"  width="100%" value="${item.stockhigh}"/></td>
            <td><label for="itemWeight$text">物料重量</label></td>
            <td><input id="itemWeight"  name="itemWeight" class="mini-textbox"  width="100%" value="${item.itemweight}"/></td>
            <td><label for="weightUnit$text">重量单位</label></td>
            <td><input id="weightUnit"  name="weightUnit" class="mini-textbox"  width="100%" value="${item.weightunit}"/></td>
        </tr>
        ...
        <tr height="60px;">
	        ...
	        <td colspan="5"><input id="memo"  name="memo" class="mini-textarea" emptyText="请输入备注" 
	        	width="100%" height="100%"  value="${item.memo}"/></td>
         </tr>
        <!-- 
       	<tr>
   ...
   <script>
		...
		function addItem(){
			...
			var productId = mini.get("itemId").getValue();
