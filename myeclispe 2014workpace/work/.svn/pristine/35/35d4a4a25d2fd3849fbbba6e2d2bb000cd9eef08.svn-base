...
public class CheckinDetl {
	private String checksheetId="";
	private String checkindetlId="";
	...
	public String getCheckindetlId() {
		return checkindetlId;
	}
	public void setCheckindetlId(String checkindetlId) {
		this.checkindetlId = checkindetlId;
	}
