...
<!--		<span class="separator"></span>-->
   ...
   <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
    ...
    <input id="warehouseId" name="warehosueId" class="mini-hidden" value="${warehouse_id }" readonly/>
    <input id="warehouseName" name="warehosueName" class="mini-hidden" value="${warehouseName }" readonly/>
    ...
    <div id="editform" class="form" >
     ...
     <script type="text/javascript">
	    ...
	    var itemName="";
	    grid.load({warehouseId:warehouseId,itemName:""});
