  ...
  <body style="height: 95%;">
   <div id="tabs1" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" plain="false"
		    buttons="#tabsButtons" refreshOnClick="true">
		     <div title="库房信息" iconCls="icon-node" showCloseButton="false" url="warehouseDefi/WarehouseImfo.jsp"></div>
		    <div title="新增库房"  iconCls="icon-add" showCloseButton="false" url="warehouseDefi/AddWarehouse.jsp"></div>
