  	...
  	<fieldset id="allDetail" style="width: 100%;" align="center">
		...
		<form id="checkout" name="checkout"  action="#" method="post">
   		...
   		<tr bgcolor=#EBEFF5>
            ...
            <td><input id="checkout_date"  name="checkout_date" class="mini-datepicker"  width="100%" required="true"  dateFormat="yyyy-MM-dd" allowInput="false" format="yyyy-MM-dd" 
            ...
            <td><input id="checksheet_id" name="checksheet_id" class="mini-textbox" width="100%"enabled="false" required="true" value="${checkout.checksheetId}" /></td>
...
<!--       <td><input id="operator" name="operator"  class="mini-buttonedit" width="100%" textName="operatorName" enabled="false" onbuttonclick="onButtonEditEmployee" allowInput="false" -->
<!--       required="true" ></td>-->
        </tr>
       	<tr bgcolor=#EBEFF5>
   		...
   		<input id="status" name="status" class="mini-hidden" enabled="false" value="${checkout.status }"/>
     ...
     <script type="text/javascript">
	    ...
	    {	
	    	...
	    	if(status==1){
	    		...
	    		var order_id=mini.get("order_id").getValue();
	    		var checksheet_id=mini.get("checksheet_id").getValue();
	    		var warehouse_id=mini.get("warehouse_id").getValue();
	    		window.location="editDetailCheckoutServlet?checksheet_id="+checksheet_id+"&itemId="+itemId+"&warehouse_id="+warehouse_id+"&order_id="+order_id;
	    	}
