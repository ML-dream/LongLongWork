...
<html>
  ...
  <body>
  	<div class="mini-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;"> 
	            <a class="mini-button" iconCls="icon-add" plain="false" onclick="addRow()">新增</a>
   	...
   	<table style="text-align: right;border-collapse:collapse;" border="gray 1px solid;"  width="100%" >
   		<tr>
            ...
            <td><input id="deptName"  name="deptName" class="mini-textbox"  width="100%" required="true" emptyText="20个以内汉字" value="${dept.deptName}"/></td>
   			...
   			<td><input id="FDeptId" name="FDeptId" class="mini-buttonedit" width="100%" onbuttonclick="onButtonEdit"required="true" value="${dept.FDeptId}" text="${dept.deptName}"/></td>
   		</tr>
        <tr>
