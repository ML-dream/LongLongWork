    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|',  'insertvideo', 'insertimage','attachment', 'map', 'gmap', 'insertframe','highlightcode','webapp','pagebreak', '|',
       ...
       , toolbars: [[    'undo', 'redo',
	        	        '|','bold','italic','underline',
	        	            ...
	        	            'inserttable',
	        	        '|','attachment' ,'insertimage','link', 'unlink']]
        ...
        ,labelMap:{
            ...
            'fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式',  'inserttable':'表格', 'link':'超链接',
