	...
	<body style="height: 95%;">
		<div id="tabs1" class="mini-tabs" activeIndex="0" style="width:100%;height:100%;" plain="false"
		   ...
		   <!--   <div title="产品进库" iconCls="icon-add" showCloseButton="false" url="SheetIdServlet"></div> -->
		    <div title="入库审核" iconCls="icon-add" showCloseButton="false" url="Checkin/examineProductCheckin.jsp"></div>
		    <div title="入库记录"  iconCls="icon-node" showCloseButton="false" url="Checkin/showCheckin.jsp"></div>
