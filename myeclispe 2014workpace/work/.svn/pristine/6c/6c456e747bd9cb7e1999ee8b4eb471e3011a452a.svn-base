...
public class CheckFoDetailServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    String sql="select count(*) from fo_detail where product_Id=? and issue_NUM=? and isInUse='1'";
...
//	    修改工艺内容为工艺文件，foOpcontent替换为 craftpaper
	    String Sql= "select foId,PRODUCT_TYPE productType,PRODUCT_ID productId,ISSUE_NUM issueNum,ITEM_ID itemId,FO_NO foNo," +
				"FO_OPNAME foOpName,FO_OPCONTENT ,RATED_TIME ratedTime,PLAN_TIME planTime,OPER_AIDTIME operAidTime," +
				...
				"WB.typename workBranchName,craftpaper foOpcontent " +
