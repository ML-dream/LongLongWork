...
//		String s = request.getParameter("productName");
//		String productName = ChineseCode.toUTF8(StringUtil.isNullOrEmpty(request.getParameter("productName"))?"":request.getParameter("productName").trim());
		String productName = StringUtil.isNullOrEmpty(request.getParameter("productName"))?"":request.getParameter("productName").trim();
