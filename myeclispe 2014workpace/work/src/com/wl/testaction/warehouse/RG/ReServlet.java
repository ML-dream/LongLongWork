	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			if(!itemId1.equals("")){
				...
				PrData.getReData(request,datamap,reSheetid,itemId1,
			...
			if(!itemId2.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId2,
			...
			if(!itemId3.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId3,
			...
			if(!itemId4.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId4,
			...
			if(!itemId5.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId5,
			...
			if(!itemId6.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId6,
			...
			if(!itemId7.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId7,
			...
			if(!itemId8.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId8,
			...
			if(!itemId9.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId9,
			...
			if(!itemId10.equals("")){
				PrData.getReData(request,datamap,reSheetid,itemId10,
