...
public class addPoPaymentServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public addPoPaymentServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String Sql="insert into initialpopayment (adddate,companyid,initialpayment) values " +
