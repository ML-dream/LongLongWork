...
public class examineCheckoutServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public examineCheckoutServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    try {
		 ...
		 String sql="select CHECKOUT_DATE,CHECKSHEET_ID,B.COMPANYID,B.WAREHOUSE_ID,C.WAREHOUSE_NAME warehouseName,F.COMPANYNAME companyname,F.CONNECTOR connector," +
		 		"F.CONNECTORTEL connectortel,DELIVERY,D.staff_name deliveryName,OPERATOR,E.staff_name operatorName,ORDER_ID,B.CREATEPERSON,B.CREATETIME,B.CHANGEPERSON,B.CHANGETIME,STATUS from " +
