...
//		String createTime = df.format(new Date());
		...
		if(item_id1.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id1",item_id1,
		...
		if(item_id2.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id2",item_id2,
		...
		if(item_id3.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id3",item_id3,
		...
		if(item_id4.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id4",item_id4,
		...
		if(item_id5.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id5",item_id5,
		...
		if(item_id6.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id6",item_id6,
		...
		if(item_id7.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id7",item_id7,
		...
		if(item_id8.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id8",item_id8,
		...
		if(item_id9.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id9",item_id9,
		...
		if(item_id10.length()>0){
			CheckData.Checkin(request,datalist,checksheet_id,"checkindetl_id10",item_id10,
