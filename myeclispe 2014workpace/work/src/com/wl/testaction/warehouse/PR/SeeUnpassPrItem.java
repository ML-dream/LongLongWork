...
public class SeeUnpassPrItem extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public SeeUnpassPrItem() {
		super();
	}
...
System.out.println(this.getClass().getName());
		...
		String sqla ="select * from("+
			...
			"a.item_typedesc itemtypename,b.warehouse_name warehousename,t.status,t.remark ,rownum rn from PRDETAIL t" +
