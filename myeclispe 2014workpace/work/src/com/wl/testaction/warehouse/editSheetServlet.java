	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    try{
			...
			if(checkin_num!=checkin_num1){
				Stockcl.Stockout(request,item_id, checkin_num1);
				Stockcl.Stockin(request,item_id, item_name,spec, item_type, warehouse_id, stock_id, checkin_num,unitprice, unit);
			}
