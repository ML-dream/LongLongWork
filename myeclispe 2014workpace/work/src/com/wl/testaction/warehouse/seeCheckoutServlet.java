...
public class seeCheckoutServlet extends HttpServlet {
...
//		String sql="select CHECKOUT_DATE,CHECKSHEET_ID,B.COMPANYID,F.COMPANYNAME,B.WAREHOUSE_ID,C.WAREHOUSE_NAME warehouseName,F.CONNECTOR,OPINION," +
...
// 		"where checksheet_id='"+checksheet_id+"'";
		...
		request.getRequestDispatcher("/Checkout/seeCheckout.jsp").forward(request, response);
