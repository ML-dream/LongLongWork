...
public class ProductCheckinSheetid extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ProductCheckinSheetid() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/qualitycheck/ProductCheckin/ProductCheckin.jsp").forward(request,response);
	}
