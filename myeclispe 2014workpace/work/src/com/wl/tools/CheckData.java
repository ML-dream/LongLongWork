...
public class CheckData {
	//入库
	public static void Checkin(HttpServletRequest request,HashMap datalist,String checksheet_id,String checkindetl_id,String item_id,String item_name,
		...
		try{
			...
			Stockcl.Stockin(request,item_id,item_name1,spec1,item_type1,warehouse_id,stock_id1,checkin_num1,unitprice1,unit1);
