...
public class PrData {
	public static void getPrData(HttpServletRequest request,HashMap datamap,String prSheetid,String itemId,String poSheetId1,String itemName1,
		...
		try{
			...
			Stockcl.Stockin(request,itemId,itemName,spec,itemType,warehouseId,stockId,prNum,unitPrice,unit);
	...
	//采购退货
	public static void getReData(HttpServletRequest request,HashMap datamap,String reSheetid,String itemId,String itemName1,
		...
		try{
			...
			Stockcl.Stockout(request,itemId,reNum);
