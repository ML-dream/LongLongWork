...
public class LlData {
	public static void getLlData(HttpServletRequest request,HashMap datamap,String ll_sheetid,String item_id1,String item_name1,
		...
		try{
			...
			Stockcl.Stockout(request,item_id,ll_num);
		}catch(Exception e){
			e.printStackTrace();
		}
	}
