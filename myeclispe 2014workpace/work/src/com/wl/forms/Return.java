...
public class Return {
	...
	public void setReSheetid(String reSheetid) {
		this.reSheetid = reSheetid;
	}
	...
	public String getAppendB() {
		return appendB;
	}
	public void setAppendB(String appendB) {
		this.appendB = appendB;
	}
