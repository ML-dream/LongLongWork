...
public class DiscardGanttSaveServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    throws ServletException, IOException {
		Object data=request.getSession().getAttribute("DiscardWillSeeParts");
...
//	    		System.out.println(start);
		      ...
		      String[] params={order.getOrderId(),order.getProductId(),order.getIssueNum(),order.getDrawingId(),operId,order.getBarcode()};
