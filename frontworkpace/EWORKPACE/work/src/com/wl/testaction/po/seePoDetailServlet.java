...
public class seePoDetailServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String poSql="select PO_SHEETID,CUSTOMERID,B.CONNECTOR,B.CONNECTORTEL,POSTART_DATE,END_DATE,SALESMAN_ID," +
		...
		request.getRequestDispatcher("/PO/seePoDetail.jsp").forward(request, response);
	}
