...
public class DoneWarePrDetailServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public DoneWarePrDetailServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("PO/donewarehousePr.jsp").forward(request, response);
	}
