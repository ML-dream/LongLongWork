	...
	<fieldset style="width: 99%;" align="center">
       ...
       <tr>
   		...
   		<tr>
            ...
            <td><input id="actuallyEndTime"  name="actuallyEndTime" class="mini-datepicker" dateFormat="yyyy-MM-dd"  width="100%" value="${process.actuallyEndTime}"/></td> 
            <td><label for="quality$text">质量情况</label></td>
	        <td><input id="quality"  name="quality" class="mini-combobox" width="100%" url="data/quality.txt"  textField="text" valueField="id" allowInput="false" renderer="onQualityRenderer" value="${process.quality}"/></td>	   		

   		</tr>
   		<tr>
   		    <td><label for="qualityFine$text">质量罚款</label></td>
	        <td><input id="qualityFine"  name="qualityFine" class="mini-textbox" width="100%" vtype="float" value="${process.qualityFine}"/></td>
   			<td><label for="alreadyPay$text">已付款</label></td>
            <td><input id="alreadyPay"  name="alreadyPay" class="mini-textbox" width="100%" vtype="float" value="${process.alreadyPay}"/></td>
            <td><label for="waitPay$text">未付款</label></td>
            <td><input id="waitPay"  name="waitPay" class="mini-textbox" width="100%" vtype="float" value="${process.waitPay}" /></td>
        </tr>
   		<tr>
            ...
            <td><input id="isOpenTicket"  name="isOpenTicket" class="mini-combobox" style="width:100%;" textField="text" valueField="id" 
    			url="data/trueOrFalse.txt"    allowInput="false"  renderer="onGenderRenderer" value="${process.isOpenTicket}"/>  
            </td>
            <td><label for="payTime$text">付款周期</label></td>
            <td><input id="payTime" name="payTime" class="mini-datepicker" dateFormat="yyyy-MM-dd"  width="100%"   value="${process.payTime}"/></td>
            ...
            <td><input id="isBusy"  name="isBusy" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/trueOrFalse.txt"    allowInput="false" showNullItem="false" renderer="onGenderRenderer" value="${process.isBusy}"/>  
    		</td>
        </tr>
   		<tr height="60px;">
   			<td><label for="memo$text">附录</label></td>
	        <td colspan="5"><input id="memo"  name="memo" class="mini-textarea" emptyText="请输入备注" 
	        	width="100%" height="100%" value="${process.memo}"/></td>
         </tr>
