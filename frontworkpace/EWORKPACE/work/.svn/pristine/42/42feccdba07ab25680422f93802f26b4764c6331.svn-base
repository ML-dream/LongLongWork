 ...
 <fieldset style="width: 100%;" align="center">
   	...
   	<div id= "userdiv">
   		...
   		<tr>
	        ...
	        <td><input id="IDCard"  name="IDCard" class="mini-textbox" width="100%"  onvalidation="onIDCardsValidation" required="true" onblur="birthdayConfirm"/></td>
       ...
       <tr>
            ...
            <td><label for="birthday$text">出生日期*</label></td>
          	<td><input id="birthday" name ="birthday" class="mini-datepicker" width="100%" dateFormat="yyyy-MM-dd" allowInput="true" required="true"/></td>
            ...
            <td><input id="educationLevel"  name="educationLevel" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..."
    			url="data/educationLevel.txt" value="BK"  required="true" allowInput="false" showNullItem="true" nullItemText="请选择..."/>  
            </td>
