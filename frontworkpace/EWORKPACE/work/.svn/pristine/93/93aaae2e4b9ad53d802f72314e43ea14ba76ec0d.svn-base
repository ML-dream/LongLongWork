...
//					response.getWriter().append(json).flush();
	    ...
	    try{
			...
			TlData.getTlData(datamap,rmSheetid,item_id1,
			...
			TlData.getTlData(datamap,rmSheetid,item_id2,
			...
			TlData.getTlData(datamap,rmSheetid,item_id3,
			...
			TlData.getTlData(datamap,rmSheetid,item_id4,
			...
			TlData.getTlData(datamap,rmSheetid,item_id5,
			...
			TlData.getTlData(datamap,rmSheetid,item_id6,
			...
			TlData.getTlData(datamap,rmSheetid,item_id7,
			...
			TlData.getTlData(datamap,rmSheetid,item_id8,
			...
			TlData.getTlData(datamap,rmSheetid,item_id9,
			...
			TlData.getTlData(datamap,rmSheetid,item_id10,
