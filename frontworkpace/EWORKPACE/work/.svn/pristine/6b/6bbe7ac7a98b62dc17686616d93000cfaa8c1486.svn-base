...
public class EndFixcardTable extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public EndFixcardTable() {
		super();
	}
...
//		9-6
		String disSql="update fixdetail set designerin='"+designerin+"',designer='"+designer+"',returndate=to_date('"+returndate+"','yyyy-mm-dd hh24:mi:ss'),dutyer='"+dutyer+"' " +
				" checker='"+checker+"',fixer='"+fixer+"',checkheader='"+checkheader+"' ishandle=1 where runnum='"+runnum+"'";
		try {
