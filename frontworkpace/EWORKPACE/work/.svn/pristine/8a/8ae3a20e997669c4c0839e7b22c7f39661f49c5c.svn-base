		...
		<form name="form1" id="form1" method="post" enctype="multipart/form-data">
			...
			<tr>
				<tr><th width=100>工序编号*</th> 
			   	...
			   	<tr><th>工序名称*</th>
			   		<td><input id="foOpName"  name="foOpName" class="mini-textbox"  width="100%" required="true"  value="${result.foOpName}" readonly/></td>
			   	</tr>
			   	<tr>
			   		<th>工种*</th>
			    ...
			    <tr>
			        ...
			        <td><input id="isCo"  name="isCo" class="mini-combobox" style="width:100%;" textField="text" valueField="id" emptyText="请选择..." value="${result.isCo}"
    					url="data/trueOrFalse.txt" value="0" allowInput="false" showNullItem="true" nullItemText="请选择..." readonly/>  
            		</td>
            		<th>是否设检</th>
            	...
            	<tr>
					...
					<td>
						<a class="mini-button" iconCls="icon-remove" plain="false"  onclick="toservlet('0');">删除此道工序</a>
