  ...
  <body>
   <div id="grid1" class="mini-datagrid" style="width:100%;height:95%;"
        ...
        <div property="columns">
            ...
            <div field="llDate" width="60" headerAlign="center" dateFormat="yyyy-MM-dd" align="center">日期
            </div>
          <div field="llSheetid" width="110" headerAlign="center" align="center">单号
          </div>  
            <div field="warehouseName" width="110" headerAlign="center" align="center">库房
            </div>
            <div field="empName" width="60" headerAlign="center" align="center">领料人
            </div>
    ...
    <script type="text/javascript">
	    ...
	    function onOperatePower(e) {
	      ...
	      //  str += "</span>";
	        str += "<span>";
	        str += "<a style='margin-right:2px;' title='查看' href=javascript:ondSee(\'" + e.row.llSheetid+"\') ><span class='mini-button-text mini-button-icon icon-node'>&nbsp;</span></a>";
	        str += "</span>";
	    	str += "<span>";
	        str += "<a style='margin-right:2px;' title='编辑' href=javascript:ondEdit(\'" + e.row.llSheetid+"\') ><span class='mini-button-text mini-button-icon icon-edit'>&nbsp;</span></a>";
	        str += "</span>";
	        //alert(e.row.staffCode);
	        return str;
	    }
	    
	    function ondEdit(llSheetid){
	    	window.location="editLlSheetServlet?llSheetid="+llSheetid;
		}

	    function ondSee(llSheetid){
	    	...
	    	window.location="showLlSheetDetailServlet?llSheetid=" +llSheetid;
		}
