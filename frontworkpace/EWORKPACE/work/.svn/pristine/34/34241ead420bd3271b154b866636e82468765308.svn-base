...
public class editCountServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String countSql="update whcount set COUNTDATE=to_date('"+CountDate+"','yyyy-mm-dd,hh24:mi:ss'),WAREHOUSEID='"+warehouseId+"',OPERATORID='"+operatorId+"',DEPTID='"+deptid+"',EMPID='"+empId+"'," +
				"changePerson='"+changePerson+"',changeTime=to_date('"+changeTime+"','yyyy-mm-dd,hh24:mi:ss') where countsheetid='"+CountSheetId+"'";
		try{
