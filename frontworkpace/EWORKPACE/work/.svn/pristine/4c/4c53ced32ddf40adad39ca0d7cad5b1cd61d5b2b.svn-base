...
<html>
  ...
  <body style="height:99%;">
  	...
  	<form id="addPoPayment" method="post" action=""> 	
    ...
    <td width="10%"><label for="companyId$text">供应商</label></td>
    <td width="15%"><input id="companyId" name="companyId" class="mini-buttonedit" width="100%" onbuttonclick="onSupplierButtonEdit" textName="companyName" required="true" 
                allowInput="false"/></td>
    <td width="10%"><label for="initialPayment$text">初始应付款</label></td>
    ...
    grid.load();
    function getForm(){
    	var addForm=new mini.Form("addPoPayment");
    	addForm.validate();
