...
<html>
 ...
 -->        
            ...
            <div field="address" width="160" headerAlign="center">详细地址</div>
            <div field="passRate" width="40" headerAlign="center">合格率(%)</div>
    ...
    <script type="text/javascript">
	    ...
	    function ondEdit(companyId,connector){
	        window.location.href = "OutAssistComSpecServlet?companyId="+companyId+"&connector="+connector;
		}
