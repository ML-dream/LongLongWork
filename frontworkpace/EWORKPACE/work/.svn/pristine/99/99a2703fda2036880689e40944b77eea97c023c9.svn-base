...
//   工艺编制树加载
		...
		String productStatusFrom = StringUtil.isNullOrEmpty(request.getParameter("productStatusFrom"))?ProductStatus.ADDED+"":request.getParameter("productStatusFrom");
		String productStatusTo = StringUtil.isNullOrEmpty(request.getParameter("productStatusTo"))?ProductStatus.ADDED+"":request.getParameter("productStatusTo");
...
//		String productStatusTo = ProductStatus.ADDED +"";
	    ...
	    StringBuffer jsonBuffer = new StringBuffer(65536);
	    jsonBuffer.append("[");
