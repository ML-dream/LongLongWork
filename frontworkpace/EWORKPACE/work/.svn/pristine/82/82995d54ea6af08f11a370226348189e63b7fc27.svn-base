   ...
   <script type="text/javascript">
   		...
   		function doB(doingtype){
		    ...
		    if(doingtype == "listPartsPlan"){
		    	document.getElementById("subIframe").src=
		    		"DiscardBaseServlet?meth=SeePartsPlan&pathTo=discardPartPlan&orderId="+orderId+"&productId="+productId+"&FProductId="+fproductId+"&issueNum="+issueNum+"&drawingId="+drawingId+"&barcode="+barcode;
		    }
