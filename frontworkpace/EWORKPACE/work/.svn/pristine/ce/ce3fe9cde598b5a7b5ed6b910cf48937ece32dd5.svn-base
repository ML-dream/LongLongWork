  ...
  <body>
    ...
    <div id="grid1" class="mini-datagrid" style="width:100%;height:90%;"  showColumnsMenu ="true" allowCellEdit="true" allowCellSelect="true"
        ...
        <div property="columns">
            ...
            <div field="batch" width="110" headerAlign="center">批号
            ...
            <div field="productPrice" width="60" headerAlign="center">金额
            </div>
            <div field="productRemark" width="110" headerAlign="center">备注
    ...
    <script type="text/javascript">
	   ...
	   function outPut(){
    		...
    		window.location="ProductSaleExcelOut?para=para&bday="+bday+"&eday="+eday+"&creater="+creater+"&status="+status+"&customer="+customer;
       }
