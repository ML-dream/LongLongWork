...
<!-- 	 	<a class="mini-button" iconCls="icon-goto" plain="false" onclick="nextForm()">下一单</a>-->
  	...
  	<div>
    	...
    	<table style="text-align: left;border-collapse:collapse;" border="gray 1px solid;"  width="99%" >
   		...
   		<td><input id="sheetId" name="sheetId" class="mini-textbox" width="100%" enabled="false" required="true" value="${sheetId }"/></td>
   		<td><label for="orderId$text">订单号</label></td>
   		<td><input id="orderId" name="orderId" class="mini-textbox" width="100%" enabled="false" required="true" value="${orderId }"/></td>
   		...
   		textName="itemName" allowinput="false"/></td>
   		</tr>
   		<tr bgcolor=#EBEFF5>
   		<td><label for="issueNum$text">版本号</label></td>
   		<td><input id="issueNum" name="issueNum" class="mini-textbox" width="100%" /></td>
   		...
   		<td><input id="returnNum" name="returnNum" class="mini-textbox" required="true" width="100%" /></td>
   		...
   		<td><input id="unitPrice" name="unitPrice" class="mini-textbox" width="100%" /></td>
   		...
   		<td><input id="qkprice" name="qkprice" class="mini-textbox" width="100%" /></td>
   		<td><label for="reason$text">退货原因</label></td>
   		<td colspan="3"><input id="reason" name="reason" class="mini-textbox" width="100%"/></td>
