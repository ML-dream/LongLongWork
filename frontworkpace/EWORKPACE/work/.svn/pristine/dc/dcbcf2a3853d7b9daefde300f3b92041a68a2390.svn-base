...
//	public static String url = "jdbc:mysql://localhost/plusoft_test?useUnicode=true&characterEncoding=utf-8";
//	public static String user = "root";
//	public static String pwd = "wanglu";
	
	
	public static String driver = DatabaseCommon.driver;
	public static String url = DatabaseCommon.url;
	public static String user = DatabaseCommon.username;
	public static String pwd = DatabaseCommon.password;
