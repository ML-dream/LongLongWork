...
<body>
<div style="width:630px; margin:0 auto; border:2px solid #6D6D6D;">
	<h1>返工/返修单</h1>
	<form id="form1">
	<table>
		<tr>
			<td><label>单号</label></td>
	 		<td><input id="runnum"  name="runnum" class="mini-textbox"  value="${runNum}" vtype="rangeLength:12,12" readonly/></td>
	 	</tr>
	 </table>
	 <table>
	 	<tr>	
		...
		<tr>
 		...
 		<tr>
 			...
 			<td><input id="rejectFO"  name="rejectfo" class="mini-textbox" readonly/>
 				<input id="fo_no"  name="fo_no" class="mini-textbox" allowInput="false" style="visibility:hidden; width:2px;" readonly/>
 			</td>
	...
	<div class="describle">
		<label>修正方法</label> </br>
		<textarea id="designerin" name="designerin" class="mini-textarea" width="100%" height="100px" emptyText="" readonly></textarea>
		</br>
		<span class="sign"><label>工艺员</label>
		<input id="designer" name="designer" class="mini-buttonedit" width="" 
            		onbuttonclick="onButtonEdit" textName="designer" readonly/>
	...
	<table>
		<tr>
 			...
 			<td width="170px">
 			<input id="dutyer" name="dutyer" class="mini-textbox" width="100%" 
            		onbuttonclick="onButtonEdit" textName="dutyer" readonly/>
            		</td>
 			
 			<td><label>检验员</label></td>
 			<td>
 			  <input id="checker" name="checker" class="mini-buttonedit" width="" 
            		onbuttonclick="onButtonEdit" textName="checker" readonly/>  
 			</td>
 		</tr>
 		<tr>
 			<td>
 			...
 			<td>
				<input id="returndate" name ="returndate" class="mini-datepicker" readonly/>
 			</td>
 			
 			<td><label>返修工作者</label></td>
 			<td>
 				<input id="fixer" name="fixer" class="mini-textbox" width="100%" 
            		onbuttonclick="onButtonEdit" textName="fixer" readonly/>
 			</td>
 			
 			<td><label>检验室主任</label></td>
 			<td>
 				<input id="checkheader" name="checkheader" class="mini-buttonedit" width="" 
            		onbuttonclick="onButtonEdit" textName="checkheader" readonly/>
 			</td>
 		</tr>
 	</table>	
	</form>
