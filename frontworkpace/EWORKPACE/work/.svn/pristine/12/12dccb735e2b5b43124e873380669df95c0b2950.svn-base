...
public class AddMachineHireServlet extends HttpServlet {

	private static final long serialVersionUID = -8342637344117466099L;
	...
	throws ServletException, IOException {
		...
		String sql = "insert into machineHire " +
				"(mainId,machineId,deptId,hireStatus,outDate,inDate,backDate,hireMoney,hireNum,principal,memo," +
				"createPerson,createTime,changePerson,changeTime)" +
				"values('"+UUID+"','"+machineId+"','"+deptId+"','"+hireStatus+"'," +
				"to_date('"+outDate+"','yyyy-mm-dd,hh24:mi:ss'),to_date('"+inDate+"','yyyy-mm-dd,hh24:mi:ss'),to_date('"+backDate+"','yyyy-mm-dd,hh24:mi:ss')," +
				"'"+hireMoney+"','"+hireNum+"','"+principal+"','"+memo+"'," +
