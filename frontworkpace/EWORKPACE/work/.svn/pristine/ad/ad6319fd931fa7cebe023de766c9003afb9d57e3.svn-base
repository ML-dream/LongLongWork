...
public class ChangeProductStatusServlet extends HttpServlet {
	...
	throws ServletException, IOException {
	    ...
	    String productStatus = ChineseCode.toUTF8(request.getParameter("productStatus").trim());
	    ...
	    String sql = "update order_detail set product_status='"+productStatus+"',changePerson='"+changePerson+"',changeTime=to_date('"+changeTime+"','yyyy-mm-dd,hh24:mi:ss')  " +
