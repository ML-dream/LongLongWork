    		...
    		<table class="green_list_table" align="center" width="100%" height="50%" border="1" style="word-break:break-all;border-collapse:collapse" bgcolor="#dafec5">
    			<tr>
      				...
      				<td><!--<select id="oper_id" name="oper_id" style="width:130px;">
	         			...
	         			<input id="foNo" name="foNo" class="mini-textbox"  width="100%" required="true" readonly value="${result.foNo}"/></td>
	         	</tr>
   				<tr><th>使用刀具</th>
				...
				<tr><td><a class="mini-button" iconCls="icon-save" plain="false"  onclick="toservlet()">保存</a>
	     			...
	     			<input id="productId"  name="productId" class="mini-hidden"  width="100%" value="${result.productId}"/>
	     			<input id="issueNum"  name="issueNum" class="mini-hidden"  width="100%" value="${result.issueNum}"/>
				</tr>
			</table>
			<br>
		</form>
