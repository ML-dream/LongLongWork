...
public class editDataMaintenanceServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public editDataMaintenanceServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String Sql="update paystatistics set endpayment='"+endPayment+"' where companyid='"+companyId+"' and " +
		...
		String editSql="insert into editpaystatistics (companyid,maintenancedate,editendpayment,initialendpayment,editperson,edittime,reason) " +
