...
public class LoadWaitDis extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql="select * from "+
			"(select z.*,rownum rn from(select a.runnum,c.fo_no,c.occurdate,c.barcode,b.fo_opname,b.checkdate from disdetail a "+
		...
		String totalsql="select count(*) from (select runnum from disdetail where ishandle=0)";
		int total = 0;
