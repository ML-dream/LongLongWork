...
public class getAddSupplierDataMaintenanceFormServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public getAddSupplierDataMaintenanceFormServlet() {
		super();
	}
...
//		String maintenanceDate=request.getParameter("maintenanceDate");
		...
		String minSql="select min(maintenancedate) from supplierpaystatistics where companyid='"+companyId+"'";
		...
		String Sql="select A.*,companyName from supplierpaystatistics A " +
