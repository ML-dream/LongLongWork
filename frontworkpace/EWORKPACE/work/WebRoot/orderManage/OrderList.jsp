...
<!--	</div>-->
    ...
    <script type="text/javascript">
	    ...
	    function print(){
	    	window.location="OrderInfoExcelDemoServlet";	    
	    }
	    ...
	    function ondEdit(orderId,connector){
	    	...
	    	window.location="OrderSpecServlet?orderId=" + orderId+"&connector="+connector+"&isModify="+"0";
		}
	    ...
	    function ondAdd(orderId,connector){
	    	...
	    	window.location="orderManage/AddOrderDetailMain.jsp?orderId=" + orderId+"&connector="+connector+"&isModify="+"0";
		}
		...
		function onAllDetail(orderId,connector){
			window.location="GoOrderAllDetailServlet?orderId=" + orderId+"&connector="+connector+"&isModify="+"0";
		}
        ...
        var Genders=[{id: "1", text: "新建"},{id: "2", text: "待审核"},{id: "3", text: "提交上级审核"},{id: "4", text: "审核不通过"},{id: "5", text: "审核通过"},	
	                {id: "6", text: "备料"},{id: "7", text: "待加工"},{id: "8", text: "加工中"},{id: "9", text: "完成"},{id: "10", text: "交付中"},{id: "11", text: "交付完成"}]
