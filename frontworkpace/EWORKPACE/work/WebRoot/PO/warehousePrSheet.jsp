...
<html>
  ...
  <body>
    ...
    multiSelect="true" idField="id" showSummaryRow="true" allowAlternating="true" showPager="true"  pageSize="20"
     showFilterRow="true" url="WarePrServlet">
...
<!--    		<div field="payTerm" headerAlign="center" align="center">交货期限</div>-->
    		<div field="drawerName" headerAlign="center" align="center">开单人</div>
    ...
    var str="";
    str+="<span>";
    str+="<a style='margin-right:2px;' title='查看详情' href=javascript:ondSee(\'"+e.row.prSheetid+"\')><span class='mini-button-text mini-button-icon icon-node'>&nbsp;</span></a>";
    str+="</span>";
    return str;
    }
    ...
    window.location="WarePrDetailServlet?prSheetid="+prSheetid;
    
    }
    
    function ondEdit(prSheetid){
    window.location="editPrServlet?prSheetid="+prSheetid;
