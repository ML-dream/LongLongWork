...
<html>
 ...
 <a class="mini-button" plain="false" iconCls="icon-undo" onclick="javascript:window.history.back(-1);">返回</a>
  ...
  <tr bgcolor=#EBEFF5>
	  ...
	  <td><input id="salesmanId" name="salesmanId"  class="mini-buttonedit" value="${prsheet.salesmanId  }"  text= "${prsheet.salesmanName   }" width="100%" textName="salesmanName" onbuttonclick="onButtonEditEmployee" allowInput="false" required="false"></td>
	  <td><label for="drawerId$text">开单人</label></td>
	  <td><input id="drawerId" name="drawerId"  class="mini-buttonedit" value="${prsheet.drawerName  }" text= "${prsheet.drawerName   }" width="100%" textName="drawerName" onbuttonclick="onButtonEditEmployee" allowInput="false" required="false"></td>
  </tr>
  </table>
  
  <div id="tablediv">
   	 <div id="datagrid1" class="mini-datagrid" style="width:1300px;height:530px;" 
        url="SeePrItem?key=${prsheet.prSheetid}" idField="id" allowResize="true" pageSize="20"   multiSelect="true" allowCellSelect="true" allowCellEdit="true"
