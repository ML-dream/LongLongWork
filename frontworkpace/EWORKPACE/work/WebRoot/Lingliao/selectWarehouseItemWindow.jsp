...
<html>
  ...
  <body>
    ...
    <div class="mini-fit">
  		...
  		<input id="itemName" name="itemName" class="mini-textbox" onenter="onSearch()"/>
        ...
        <div id="grid1" class="mini-datagrid" style="width:100%;height:100%;" idField="id" allowResize="true"
            ...
            <div property="columns">
	            ...
	            <div field="itemTypeDesc"  headerAlign="center" align="center">物料种类 </div>
...
<!--	            <div field="itemdrawing" width="100" headerAlign="center">图号</div>-->
	            <div field="spec"  headerAlign="center" align="center">物料规格</div>
            	 <div field="unit"  headerAlign="center" align="center">单位</div>
            	<div field="unitPrice"  headerAlign="center" align="center">单价</div>  
            	<div field="stockNum" headerAlign="center" align="center">库存量</div>
...
<script type="text/javascript">
    ...
    grid.setUrl("GetWarehouseItemServlet");
