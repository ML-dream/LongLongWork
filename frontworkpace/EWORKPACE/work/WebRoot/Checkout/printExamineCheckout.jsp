...
<!--  		<span class="separator"></span>-->
  	...
  	<!--startprint-->
  	<fieldset id="allDetail" style="width:1000px;" align="center">
		<legend>
			出库单详细信息
		</legend>
   		<table style="text-align: right;border-collapse:collapse;" border="gray 1px solid;"  width="1000px" >
   		<tr bgcolor=#EBEFF5>
            ...
            <td><input id="checksheet_id" name="checksheet_id" class="mini-textbox" width="100%" required="true" enabled="false" value="${checkout.checksheetId}" /></td>
   			 <td width="10%"><label for="companyname$text">收货单位</label></td>
...
<!--   			<td width="60"><label for="order_id$text">订单号</label></td>-->
...
<!--            textName="orderId" required="true" enabled="false" allowInput="false"/></td>-->
        ...
        <tr bgcolor=#EBEFF5>
  		...
  		<td colspan="5"><input id="opinion" name="opinion" class="mini-textarea" width="100%" enabled="false" height="70px" emptyText="请输入意见" value="${checkout.opinion }"></td>
  		</tr>
   		</table>
   		
   		<div id="grid1" class="mini-datagrid" style="width:1000px;height:780px;"
    	multiSelect="true"  idField="id" showSummaryRow="true" allowAlternating="true" showPager="true"
		url="seeDetailCheckoutServlet?checksheetId=${checkout.checksheetId}&warehouseId=${checkout.delivery }">
        <div property="columns">
            <div type="indexcolumn">序号</div>

            <div field="itemId" headerAlign="center" align="center" width="100">物料编号 </div>
            <div field="itemName" headerAlign="center" align="center" width="100">物料名称</div>
            <div field="issueNum"  headerAlign="center" align="center" width="60">版本号</div>
            <div field="itemTypeDesc" headerAlign="center" align="center" width="60">类型</div>
            <div field="spec" headerAlign="center" align="center" width="60">规格</div>
            <div field="unit"  headerAlign="center" align="center" width="60">单位</div>
            <div field="purductNum"  headerAlign="center" align="center" width="60">订单总数</div>
            <div field="alreadyPayNum"  headerAlign="center" align="center" width="80">已交付数量</div>
            <div field="noPayNum"  headerAlign="center" align="center" width="80">未交付数量</div>
            <div field="checkoutNum" headerAlign="center" align="center" width="80">本次出库数量</div>
            <div field="unitprice"  headerAlign="center" align="center" width="60">单价</div>
            <div field="price" headerAlign="center" align="center" width="60">金额 </div>
            <div field="stockId"  headerAlign="center" align="center" width="60">库位</div>
     ...
     <script type="text/javascript">
   	...
   	var btnEdit = this;
	    ...
	    function printCheckout(){
	    	var sheetId=mini.get("checksheet_id").getValue();
      		window.open("printCheckoutServlet?sheetId="+sheetId,
