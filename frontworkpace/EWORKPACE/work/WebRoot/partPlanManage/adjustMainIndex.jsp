	...
	<div id="win1" class="mini-window" title="操作" style="width:550px;height:150px;" expanded="true"
	  	...
	  	<form id="form1">
	   	 ...
	   	 <table style="text-align: left;border-collapse:collapse;" border="gray 1px solid;"  width="100%" >
	   		<tr>
	            ...
	            <td >
					<input id="bdate" name ="bdate" class="mini-datepicker" value="2017-01-01" dateFormat="yyyy-MM-dd" allowInput="false"/></td>
				<td><label>结束</label></td>
	           <td><input id="edate" name ="bdate" class="mini-datepicker" value="2017-01-01" dateFormat="yyyy-MM-dd" allowInput="false"/></td>
	  		</tr>
	   		<tr>
	   			<td>其他方式</td>
	   			<td><label>零件名称</label></td>
	            <td><input id="productName" name="productName" class="mini-textbox" width="100%"  allowInput="true" onvaluechanged="findProduct"/></td>
		...
		<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    <div showHeader="false" region="west" width="180" maxWidth="250" minWidth="100" >
		    	...
		    	<a class="mini-button" iconCls="icon-search" plain="false" onclick="search()" >查找</a>
		        <ul id="leftTree" class="mini-tree" style="width:100%;height:95%;"
		        	url="GetOrderTreeServlet1?orderStatusFrom=<%=OrderStatus.PASS%>&orderStatusTo=<%=OrderStatus.DELIVERING%>" autoLoad="false"
		...
		<script>
			...
			function findProduct(){
				...
				tree.setUrl("GetOrderTreeServlet1?orderStatusFrom=5&orderStatusTo=11&noLoad=0");
				tree.load({para:"seePartPlan",bdate:bdate,edate:edate,productName:productName,productId:productId});
				tree.expandAll();
			}
