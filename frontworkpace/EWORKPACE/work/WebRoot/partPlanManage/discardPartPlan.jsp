		...
		<div id="add" style="background:#dafec5" >
			...
			<tr>
            	...
            	<tr><input class="mini-hidden" id="productTypeId" name = "productTypeId" value="${result.productTypeId}"/>
					...
					<input class = "mini-hidden" id="barcode" name = "barcode" value="${result.barcode}"/>
				</tr>
			</table>
	...
	function doPartPlan(){
   	...
   	*/
   	...
   	function allPartsGandT(){
   	    ...
   	    var data =["{'orderId':'"+orderId+"','productId':'"+productId+"','issueNum':'"+issueNum+"','drawingId':'"+drawingId+"','barcode':'"+barcode+"'}"];
   	    data = JSON.stringify(data);
    	params = {'data':data}; 			
    	var url = 'DiscardBaseServlet?meth=GoPartGT&pathTo=partProGT';
    			jQuery.post(url, params, function(data){
      window.location.href = 'partPlanManage/discardPartProGT.jsp';},'json');
