  ...
  <body style="height:100%;">
    <div id="layout1" class="mini-layout" style="width:100%;height:100%;">
		    ...
		    <div title="center" region="center" bodyStyle="overflow:hidden;">
		        <iframe id="mainframe" frameborder="0" name="main" style="width:100%;height:100%;" src="payMent/payMentList.jsp" border="0"></iframe>
		    </div>
		</div>
		<script> 
			mini.parse();
	        ...
	        function onNodeSelect(e) {
		       ...
		       // }	
        		...
        		iframe.src = "getCompanyIdServlet?companyId="+node.id;
		        }
	        	if(node.level==2){			//零件层
