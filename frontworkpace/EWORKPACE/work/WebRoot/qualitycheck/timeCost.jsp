...
<html>
  ...
  <body>
	...
	<div id="tablediv">
        ...
        url="" idField="id" allowResize="true" pageSize="10"   multiSelect="true" allowCellSelect="true" allowCellEdit="true"
    ...
    >
 		<div property="columns">
            ...
            <div field="" width="60" headerAlign="center" allowSort="false">订单号</div>
            <div field="" width="60" headerAlign="center" allowSort="false">产品名称</div>    
            <div field="" width="60" headerAlign="center" allowSort="false">图号</div> 
            <div field="" width="60" headerAlign="center" allowSort="false" visible="true">工序号
            	<input property="editor" class="mini-textbox" style="width:100%;" minHeight="20"  value=""/>
            </div>
            <div field="" width="60" headerAlign="center" allowSort="false">工序名称</div> 
            <div field="" width="60" headerAlign="center" allowSort="false">工种</div> 
            <div field="" width="60" headerAlign="center" allowSort="false">单价</div> 
        </div>
     </div>
