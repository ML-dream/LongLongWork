...
<html>
 ...
 <body>
  <div class="mini-toolbar">
  		...
  		<a class="mini-button" iconCls="icon-save" plain="false" onclick="getForm(0)">保存</a>
  		<span class="separator"></span>
  	...
  	<div id="checkindiv">
		...
		<form id="checkin">
  		<table style="text-align: center;border-collapse:collapse;" border="gray 1px solid;"  width="99%">
  			...
  			<td><input id="checksheetId" name="checksheetId" class="mini-textbox" required="true" width="100%"/></td>
...
<!--  			 textField="text" valueField="id" emptyText="请选择..." nullItemText="请选择..." shouwNullItem="true" allowInput="false" url="GetItemTypeServlet"/></td>		-->
  			...
  			<td><input id="unit" name="unit" class="mini-textbox" required="true" width="100%"/></td>			
  			</tr>
  			<tr bgcolor=#EBEFF5>
