  ...
  <body>
  	...
  	<form id="form1">
   		...
   		<!-- 表头 -->
   			<tr>
	            ...
	            <td >
   					<input id="orderId"  name="orderId" class="mini-textbox" width="240px" enabled="false" allowInput="false"/></td>
   				<td><label>零件图号</label></td>
	            <td><input id="productId" name="productId" class="mini-textbox" enabled="false" allowInput="false"/></td>
   				<td><label>零件名称</label></td>
	            <td><input id="ProductName" name="productName" class="mini-textbox" enabled="false" allowInput="false"/></td>
	            <td><label>零件数量</label></td>
	            <td><input id="productNum" name="productNum" class="mini-textbox" enabled="false" allowInput="false"/></td>
   			</tr>
   	 	</table>
   	 </form>
    ...
    <script type="text/javascript">
       ...
       // grid.load({partsplanid:row.partsplanid});
        grid.load({productId:row.productId,issueNum:row.issueNum,orderId:row.orderId});
