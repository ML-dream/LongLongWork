...
<body>
	<div>
		<table>
			...
			<tr>
					<input id="barcode" name ="barcode" class="mini-hidden" allowInput="true" onenter="search()"/>
 				<td>产品来源</td>
				<td>
	...
	<div id="tablediv">
        ...
        <div property="columns">
           	...
           	<div field="shouldBe" width="60" headerAlign="center" allowSort="false" headerStyle="">应测值
           	</div> 
           	<div field="realBe" width="60" headerAlign="center" allowSort="false" headerStyle="">实测值
           	</div> 
           	...
           	<div field="qualityFee" width="50" headerAlign="center" allowSort="false" vtype="float;" headerStyle="">质量罚款
           	</div>
